...
def visualize_icp_result(source_pc, target_pc, pose):
    '''
    Visualize the result of ICP with a coordinate axis.
    ...
    # Create a coordinate frame (axis) at the origin
    axis = o3d.geometry.TriangleMesh.create_coordinate_frame(size=0.1, origin=[0, 0, 0])

    o3d.visualization.draw_geometries([source_pcd, target_pcd, axis])
